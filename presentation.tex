...
\begin{frame}
	\frametitle{Convolutional NN}
	\centering
    \includegraphics[width=\textwidth]{image/cnn.png}            
    \begin{itemize}
	\item Powerful representation extractors.		
	\end{itemize}
\end{frame}	

\begin{frame}
	\frametitle{Convolutional NN: u-net}
	\centering
    \includegraphics[width=\textwidth]{image/unet.jpeg}            
\end{frame}	


\begin{frame}
	\frametitle{Recurrent NN}
	\centering
    \includegraphics[width=\textwidth]{image/rnn.png}   
    \begin{itemize}
	\item Capable of universal computation.
	\item Natural sequence processors.
	\item Works with variable lenght input/output sequences.
	\end{itemize}
\end{frame}	

\begin{frame}
	\frametitle{Recurrent: LSTM}
    \centering                    
    \includegraphics[width=\textwidth]{image/lstm.jpg}  
\end{frame}	

\begin{frame}
	\frametitle{Image captioning: CNN+LSTM}
    \centering                    
    \includegraphics[width=\textwidth]{image/captioning.png}  
\end{frame}	


\begin{frame}
	\frametitle{Cross modal distillation}
    \centering                    
    \includegraphics[width=\textwidth]{image/cmd.jpg}  
\end{frame}	
...
\begin{frame}
    ...
    \centering                    
    \includegraphics[width=\textwidth]{image/faster.png}  
\end{frame}	
